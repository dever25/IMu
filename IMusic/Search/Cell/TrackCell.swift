...
//  IMusic
//
//  Created by Дмитрий Рудаков on 22.12.2020.
//
...
class TrackCell: UITableViewCell {
    ...
    @IBAction func addTrackAction(_ sender: UIButton) {
        ...
        var listOfTrack = defaults.savedTracks()
        listOfTrack.append(cell)
        
        if let savedData = try? NSKeyedArchiver.archivedData(withRootObject: listOfTrack, requiringSecureCoding: false) {
