...
class TrackDetailView: UIView {
    ...
    override func awakeFromNib() {
        ...
        let scaleMiniPlay: CGFloat = 0.5
        miniPlayPauseButton.transform = CGAffineTransform(scaleX: scaleMiniPlay, y: scaleMiniPlay)
    ...
    private func updateCurrentTimeSlider() {
        ...
        let percentage = currentTimeSeconds / durationSecons
